...
export * from './Header' // This exports the AppHeader component from Header.tsx
...
export * from './rails/DateSelectionRail' // Export the DateSelectionRail component
...
export * from './popups/CategoryDialog' // Export the CategoryDialog component
